...
// Page configuration.
$PAGE->set_url('/local/nolej/library.php', ['contextid' => $context->id]);
...
$managementurl = new moodle_url('/local/nolej/management.php', ['contextid' => $context->id]);

$templatecontext = (object) [
    'modules' => $modulearray,
    'createurl' => $createurl->out(false),
    'managementurl' => $managementurl->out(false),
];
