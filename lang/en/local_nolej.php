...
$string['apikeyhowto'] = 'To obtain an API key, you have to create an account on live.nolej.io first and then contact Nolej at info@nolej.io, requesting an API key for your registered email address.';
