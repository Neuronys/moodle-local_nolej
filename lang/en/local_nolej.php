...
$string['errdocument'] = 'An error occurred during the creation of Nolej module:<br><pre>{$a}</pre><br>Please try again or contact an administrator if this error persists.';
...
$string['limitmaxsize'] = 'File maximum size: {$a}.';
...
$string['activitiescrosswordshort'] = 'Crossword';
...
$string['activitiesdragthewordshort'] = 'Drag the word';
...
$string['activitiesfindthewordshort'] = 'Find the word';
...
$string['activitiesglossaryshort'] = 'Glossary';
$string['activitiesgrade'] = 'Conceptual assessment';
$string['activitiesgradeshort'] = 'Quiz';
...
$string['activitiesgradeqshort'] = 'Contextual assessment';
$string['activitiesgradeqquestions'] = 'Defines how many questions should appear in the contextual assessment activity';
$string['activitieshoquestions'] = 'Suggested activities';
$string['activitieshoquestionsshort'] = 'Activities';
...
$string['activitiespracticeshort'] = 'Concept cards';
...
$string['activitiespracticeqshort'] = 'Context cards';
...
$string['activitiessummaryshort'] = 'Summary';
