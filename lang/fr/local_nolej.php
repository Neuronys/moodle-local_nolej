...
$string['statusrevision'] = 'Analyse terminée';
...
$string['limitvideo'] = 'Limites Vidéo';
...
$string['limitmaxsize'] = 'Taille maximale de fichier: {$a}.';
...
$string['activitiescrosswordshort'] = 'Mots croisés';
...
$string['activitiesdragthewordshort'] = 'Glisser-déposer';
...
$string['activitiesfindthewordshort'] = 'Mots-mêlés';
...
$string['activitiesglossaryshort'] = 'Glossaire';
$string['activitiesgrade'] = 'Évaluation conceptuelle';
$string['activitiesgradeshort'] = 'Évaluation conceptuelle';
...
$string['activitiesgradeqshort'] = 'Évaluation contextuelle';
...
$string['activitieshoquestions'] = 'Activités Suggérées';
$string['activitieshoquestionsshort'] = 'Activités';
$string['activitiesibook'] = 'Livre Interactif';
$string['activitiesibookshort'] = 'Livre Interactif';
$string['activitiesivideo'] = 'Vidéo Interactive';
$string['activitiesivideoshort'] = 'Vidéo Interactive';
...
$string['activitiespracticeshort'] = 'Flashcards conceptuelles';
...
$string['activitiespracticeqshort'] = 'Flashcards contextuelles';
...
$string['activitiessummaryshort'] = 'Résumé';
