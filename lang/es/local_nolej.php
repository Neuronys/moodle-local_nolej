...
$string['limitmaxsize'] = 'Tamaño máximo del archivo: {$a}.';
...
$string['activitiescrosswordshort'] = 'Palabras cruzadas';
...
$string['activitiesibookshort'] = 'Libro interactivo';
$string['activitiesivideo'] = 'Vídeo interactivo';
$string['activitiesivideoshort'] = 'Vídeo interactivo';
...
$string['activitiespracticeshort'] = 'Tarjetas de memoria conceptuales';
...
$string['activitiespracticeflashcardsshort'] = 'Define cuántas preguntas deben aparecer en la actividad de tarjetas de memoria conceptuales';
$string['activitiespracticeq'] = 'Tarjetas de memoria contextual';
$string['activitiespracticeqshort'] = 'Tarjetas de memoria contextual';
