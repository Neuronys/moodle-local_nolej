...
$string['status_5'] = 'Überarbeitung in Bearbeitung';
$string['status_6'] = 'Überarbeitung abgeschlossen';
...
$string['languagedesc'] = 'Die Auswahl der richtigen Sprache des Mediums hilft Nolej bei der besseren Analyse.';
...
$string['questiontypetf'] = 'Wahr oder Falsch';
...
$string['conceptusefordtw'] = 'Ziehe das Wort';
...
$string['activitiescwwords'] = 'Legt fest, wie viele Wörter im Kreuzworträtsel verwendet werden sollen';
$string['activitiesdragtheword'] = 'Ziehe das Wort';
$string['activitiesdtwwords'] = 'Legt fest, wie viele Wörter in der Aktivität "Ziehe das Wort" verwendet werden sollen';
$string['activitiesfindtheword'] = 'Finde das Wort';
$string['activitiesflashcardsflashcards'] = 'Legt fest, wie viele Lernkarten in der konzeptuellen Bewertungsaktivität angezeigt werden sollen';
$string['activitiesftwwords'] = 'Legt fest, wie viele Wörter in der Aktivität "Finde das Wort" verwendet werden sollen';
$string['activitiesglossary'] = 'Glossar';
$string['activitiesgrade'] = 'Konzeptuelle Bewertung';
$string['activitiesgradequestions'] = 'Legt fest, wie viele Fragen in der konzeptuellen Bewertungsaktivität angezeigt werden sollen';
$string['activitiesgradeq'] = 'Kontextuelle Bewertung';
$string['activitiesgradeqquestions'] = 'Legt fest, wie viele Fragen in der kontextuellen Bewertungsaktivität angezeigt werden sollen';
...
$string['activitiesivideoquestions'] = 'Legt fest, wie viele Fragen pro Satz in der interaktiven Videoaktivität vorgeschlagen werden sollen. Es gibt 2 Sätze: einen in der Mitte des Videos und einen am Ende des Videos';
$string['activitiesivideosummary'] = 'Legt fest, ob die Zusammenfassung am Ende der interaktiven Videoaktivität hinzugefügt wird';
$string['activitiespractice'] = 'Konzeptuelle Lernkarten';
$string['activitiespracticeflashcards'] = 'Legt fest, wie viele Fragen in der konzeptuellen Lernkartenaktivität angezeigt werden sollen';
$string['activitiespracticeq'] = 'Kontextuelle Lernkarten';
$string['activitiespracticeqflashcards'] = 'Legt fest, wie viele Fragen in der kontextuellen Lernkartenaktivität angezeigt werden sollen';
