...
$string['limitmaxsize'] = 'Maximale bestandsgrootte: {$a}.';
...
$string['activitiescrosswordshort'] = 'Kruiswoordraadsel';
...
$string['activitiesdragthewordshort'] = 'Sleep het woord';
...
$string['activitiesfindthewordshort'] = 'Woord vinden';
...
$string['activitiesglossaryshort'] = 'Woordenlijst';
$string['activitiesgrade'] = 'Conceptuele beoordeling';
$string['activitiesgradeshort'] = 'Conceptuele beoordeling';
...
$string['activitiesgradeqshort'] = 'Contextuele beoordeling';
$string['activitiesgradeqquestions'] = 'Geeft aan hoeveel vragen moeten verschijnen in de contextuele beoordelingsactiviteit';
$string['activitieshoquestions'] = 'Voorgestelde activiteiten';
$string['activitieshoquestionsshort'] = 'Activiteiten';
$string['activitiesibook'] = 'Interactief boek';
$string['activitiesibookshort'] = 'Interactief boek';
$string['activitiesivideo'] = 'Interactieve video';
$string['activitiesivideoshort'] = 'Interactieve video';
...
$string['activitiespracticeshort'] = 'Conceptuele flashcards';
...
$string['activitiespracticeqshort'] = 'Contextuele flashcards';
...
$string['activitiessummaryshort'] = 'Samenvatting';
